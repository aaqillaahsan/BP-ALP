public class Clara extends NPC{
    ...
    public Clara(){
        ...
        //default response
        denialReactions.add("I have no idea what you're implying. Please stop.");

        //Evidence responses
        evidenceResponses.add(new EvidenceResponse("Locked Mansion","Yes, the house was locked.\nBut being trapped doesn't make everyone a killer.\nI stayed where I was told."));
        evidenceResponses.add(new EvidenceResponse("Arthur's Journal","Mr. Arthur feared many things.\nThat journal reflects his worries, not my actions."));
        evidenceResponses.add(new EvidenceResponse("Bloody Drag Marks","I never touched his body.\nThose marks were deliberate—someone wanted him hidden."));
        evidenceResponses.add(new EvidenceResponse("Arthur's Bloodied Body","I couldn't even look at him.\nWhat was done to Mr. Arthur was careful, not emotional."));
        evidenceResponses.add(new EvidenceResponse("Kitchen Knife","You think I used that knife?\nI told you Charles had it because that's what I saw.\nPointing at him doesn't mean I was hiding myself."));

        //Evidence reasons
        accuseReason.add(new EvidenceReason("Locked Mansion","The mansion was sealed.\nYou were inside with Arthur and could not be ruled out."));
        accuseReason.add(new EvidenceReason("Arthur's Journal","Arthur wrote that he feared someone close.\nYou were often present and aware of private family tensions."));
        accuseReason.add(new EvidenceReason("Bloody Drag Marks","The body was dragged through hidden areas.\nAs housekeeper, you know the mansion better than anyone."));
        accuseReason.add(new EvidenceReason("Arthur's Bloodied Body","Arthur was killed quietly without resistance.\nSomeone familiar enough not to alarm him could have done this."));
        accuseReason.add(new EvidenceReason("Kitchen Knife","The kitchen knife went missing after dinner.\nYou could have taken it and blamed Charles to draw suspicion away from yourself."));
        ...
        //Shocked dialog
        extraDialog.add(new extraDialog("Clara recoils, gripping the doorway.\nOh God… Mr. Arthur…\nHer voice shakes.\nI should have spoken sooner.\nI knew the house was too quiet."));
