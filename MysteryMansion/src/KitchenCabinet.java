public class KitchenCabinet extends Interactable{
    ...
    public KitchenCabinet(){
        ...
        conditionItem.add(new ConditionItem(new Knife(), 1, -1, "Cabinet Key", "You opened the cabinet and found a Knife in it. You should probably ask the Housekeeper about it."));
    }
