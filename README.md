...
&emsp;o Basic commands: GO (move), LOOK, TAKE, DROP, TALK, INVENTORY.  
• Implement clue collection:  
&emsp;o Certain items or NPC dialogues count as clues.   
• Track player progress:  
&emsp;o Based on collected clues and visited rooms.  
